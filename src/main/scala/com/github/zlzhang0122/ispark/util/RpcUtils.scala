...
private[spark] object RpcUtils {
   ...
   */
  def makeDriverRef(name: String, conf: SparkRpcConf, rpcEnv: RpcEnv): RpcEndpointRef = {
  ...
  def maxMessageSizeBytes(conf: SparkRpcConf): Int = {
