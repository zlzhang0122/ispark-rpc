...
private[spark] object RpcUtils {
   ...
   */
  def makeDriverRef(name: String, conf: ISparkRpcConf, rpcEnv: RpcEnv): RpcEndpointRef = {
  ...
  def maxMessageSizeBytes(conf: ISparkRpcConf): Int = {
