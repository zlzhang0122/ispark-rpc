 ...
 */
package com.github.zlzhang0122.ispark.serailizer
...
class JavaSerializer(conf: ISparkRpcConf) extends Serializer with Externalizable {
  ...
  override def newInstance(): SerializerInstance = {
    ...
    val streamFactory: SerializationStreamFactory = classLoader
      .loadClass(conf.get("spark.rpc.serialization.stream.factory", "com.github.zlzhang0122.ispark.serailizer.JavaSerializationStreamFactory"))
